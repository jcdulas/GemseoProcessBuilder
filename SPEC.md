...
This is the golden script of `examples/sellar_mdf.gpb.json`, checked against GEMSEO 6.3: `add_constraint` must always be given `constraint_type`, since its default is `"eq"`. Two more rules come from GEMSEO 6.3:
